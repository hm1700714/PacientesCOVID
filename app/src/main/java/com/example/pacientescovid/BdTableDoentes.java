...
public class BdTableDoentes implements BaseColumns {
    ...
    public static final String CAMPO_MORADA = "morada";
    ...
    public static final String CAMPO_MORADA_COMPLETO = NOME_TABELA + "." + CAMPO_MORADA;
    ...
    public static final String[] TODOS_CAMPOS = {CAMPO_ID_COMPLETO, CAMPO_NOME_COMPLETO, CAMPO_MORADA_COMPLETO,
            CAMPO_CONTACTO_COMPLETO, CAMPO_DATA_NASCIMENTO_COMPLETO };
